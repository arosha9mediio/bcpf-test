...
const FORM_TITLES = {
  // BCPF
  bcpf: "BCPF 대한민국 1인방송대상",
  safe: "공익 영상공모전",
} as const;

const BcpfAndSafe = ({ contestApply, contest, isEdit = false }) => {
    ...
    <div
      ...
      <div className="sm:w-2/3 ">
        <h1 className="text-2xl font-bold">
          {FORM_TITLES[contest?.contestType]}
        </h1>
        ...
        <Form {...form}>
          <form
            ...
            <div className="mt-12">
              <h3 className="mt-12 pb-3 font-bold">{"사업명’ 신청서"}</h3>
