...
type PressListProps = {} & FetchFilteredPostsProps;

type PressListType = (props: PressListProps) => Promise<JSX.Element>;
...
const PressList: PressListType = async params => {
...
export { PressList, fetchFilteredPosts };
